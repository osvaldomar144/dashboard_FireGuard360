...
class OverviewNamespace(Namespace):
    def on_connect(self):
        ...
        connected_clients += 1
        print(f"[WS] Client connesso a /device. Totale: {connected_clients}")
    ...
    def on_disconnect(self):
        ...
        connected_clients -= 1
        print(f"[WS] Client disconnesso da /device. Totale: {connected_clients}")
...
socketio.on_namespace(OverviewNamespace("/device"))
